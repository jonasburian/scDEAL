...
do
  ...
  #python scmodel.py --sc_data "GSE110894" --dimreduce "DAE" --drug "I.BET.762" --bulk_h_dims "256,128" --sc_h_dims "256,128" --bottleneck 512 --predictor_h_dims "128,64" --dropout 0.25 --printgene "F" -mod "new" --lr 0.01 --sampling "upsampling" --printgene "F" -mod "new" --checkpoint "False" --seed $seed --epochs 1000 --mmd_weight 0.25 --mmd_GAMMA 1000

  
  #python bulkmodel.py --drug "I.BET.762" --dimreduce "DAE" --encoder_h_dims "512,256" --predictor_h_dims "256,128" --bottleneck 128 --data_name "GSE110894" --sampling "upsampling" --dropout 0.25 --lr 0.01 --printgene "F" -mod "new" --checkpoint "False" --seed $seed
  #python scmodel.py --sc_data "GSE110894" --dimreduce "DAE" --drug "I.BET.762" --bulk_h_dims "512,256" --sc_h_dims "512,256" --bottleneck 128 --predictor_h_dims "256,128" --dropout 0.25 --printgene "F" -mod "new" --lr 0.01 --sampling "upsampling" --printgene "F" -mod "new" --checkpoint "False" --seed $seed
  ...
  python scmodel.py --sc_data "GSE149383" --dimreduce "DAE" --drug "ERLOTINIB" --bulk_h_dims "1024,512" --sc_h_dims "1024,512" --bottleneck 256 --predictor_h_dims "512,256" --dropout 0.25 --printgene "F" -mod "new" --lr 0.01 --sampling "upsampling" --printgene "F" -mod "new" --checkpoint "False" --seed $seed --epochs 500 --mmd_weight 0.5 --mmd_GAMMA 1500
  ...
  python bulkmodel.py --drug "GEFITINIB" --dimreduce "DAE" --encoder_h_dims "512,256" --predictor_h_dims "256,128" --bottleneck 256 --data_name "GSE112274" --dropout $do --lr 0.01 --printgene "F" -mod "new" --checkpoint "False" --sampling "SMOTE" --seed $seed --epochs 100
  python scmodel.py --sc_data "GSE112274" --dimreduce "DAE" --drug "GEFITINIB" --bulk_h_dims "512,256" --sc_h_dims "512,256" --bottleneck 256 --predictor_h_dims "256,128" --dropout $do --printgene "F" -mod "new" --lr 0.01 --printgene "F" -mod "new" --checkpoint "False" --seed $seed --sampling "SMOTE" --epochs 500 --mmd_weight 0.5 --mmd_GAMMA 1500
